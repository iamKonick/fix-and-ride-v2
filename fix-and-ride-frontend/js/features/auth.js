...
export function initAuth(DOM, options = {}) {
  ...
  function attachModalHandlers() {
    ...
    DOM.loginBtn.addEventListener('click', () => {
      ...
      DOM.authModal.style.display = ''; // Clear inline if any
      showTab('login');
    });

    DOM.closeAuth?.addEventListener('click', () => { DOM.authModal.classList.remove('show'); });
    window.addEventListener('click', (e) => { if (e.target === DOM.authModal) DOM.authModal.classList.remove('show'); });
